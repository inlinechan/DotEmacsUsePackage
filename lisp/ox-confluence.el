...
;; https://stackoverflow.com/questions/22119802/symbols-function-definition-is-void-incf-common-lisp-function-in-emacs24
...
(defun org-confluence--li-depth (item)
  ...
  (let ((depth -1)
    ...
    (while (and item
      ...
      (when (eq tag 'item)
        ;; (incf depth)
        ;; ‘incf’ is an obsolete alias (as of 27.1); use ‘cl-incf’ instead.
        (cl-incf depth))
